...
for d in range(len(tar)):
    ...
    for dd in range(len(tarNum)):
        ...
        loadFlg()
        rcCount = driver.find_elements_by_xpath('//*[@id="app-elt"]/div[9]/div/div[3]/div/div/a')
        rcLinks = []
        for i in rcCount:
        ...
        # ==============================
        try:
            r_name = driver.find_elements_by_xpath('//*[@id="app-elt"]/div[9]/div/div/div/table[1]/tbody/tr[1]/td[4]/strong')
        ...
        # ==============================
        try:
            obj = driver.find_elements_by_xpath('//*[@id="app-elt"]/div[9]/div/div/div/table[1]/tbody/tr[2]/td[1]')
            r_class = []
            for i in range(len(r_num)):
                arr = []
                for ii in s_rGrade:
        ...
        # ==============================
        try:
            video = driver.find_elements_by_xpath('//*[@id="app-elt"]/div[9]/div/div/div/div[3]/div/div/div[1]')
        ...
        # ==============================
        try:
            r_info = driver.find_elements_by_xpath('//*[@id="app-elt"]/div[9]/div/div/div/table[1]/tbody/tr[2]/td[1]')
        ...
        # ==============================
        try:
            rc_type = driver.find_elements_by_xpath('//*[@id="app-elt"]/div[9]/div/div/div/table[1]/tbody/tr[2]/td[2]')
        ...
        # ==============================
        try:
            rc_dist = driver.find_elements_by_xpath('//*[@id="app-elt"]/div[9]/div/div/div/table[1]/tbody/tr[1]/td[6]/strong')
        ...
        # ==============================
        try:
            r_tPrize = driver.find_elements_by_xpath('//*[@id="app-elt"]/div[9]/div/div/div/table[1]/tbody/tr[1]/td[5]/span/strong')
        ...
        # ==================================================
        try:
            h_table = driver.find_elements_by_xpath('//*[@id="app-elt"]/div[9]/div/div/div/table[2]')
        except:
        ...
        h_prize = []
        try:
            elem = driver.find_elements_by_xpath('//*[@id="app-elt"]/div[9]/div/div/div/table[1]/tbody/tr[3]/td[1]')
